...
Вікно термінала покаже перевірки й закриється, станція підніметься. Ні
встановлення, ні ярликів на робочому столі, ні правил `sudoers`.
...
Наглядач відв'язується через `setsid`, тобто отримує власний сеанс.
Перевірено: після зупинки X станція лишається живою.
