...
**Побічно про монітори:** екземпляр з аналоговим auto-adjust приймає темні поля за край екрана й центрує по вужчому вмісту, ще й скошено. Коли кадр заповнює екран впритул — стає чітко. У полі при пілларбоксі це може повторитися, і винне буде не зведення.
