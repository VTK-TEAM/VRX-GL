...
public:
    struct Config {
        ...
        // ScreenPresets: [0] ручка меню, далі пресети, замок, OSD, знімок,
        // плеєр. Кнопка редактора йде наступною, впритул: ряд читається як
        // одна смуга, а не як дві групи з пропуском.
        //
